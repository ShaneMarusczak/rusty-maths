...
///
/// # Note
/// This is the streaming version of the evaluator. It works on the complete
/// parsed expression since RPN evaluation requires access to all tokens.
pub(crate) fn evaluate_streaming(parsed_eq: &[Token], x: impl Into<Option<f32>>) -> Result<f32, String> {

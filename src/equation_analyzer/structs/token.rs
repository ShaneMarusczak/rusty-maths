...
impl TokenType {
    /// Returns true if this is a synthetic token generated by the parser
    ///
    /// Synthetic tokens (End*) are created by the parser to mark the end of
    /// variadic function parameters. They never appear in tokenizer output.
